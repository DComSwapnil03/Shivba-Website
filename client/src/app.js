...
function App() {
  ...
  switch (page.name) {
    ...
    // --> NEW: LIBRARY DASHBOARD ROUTE
    case 'library_dashboard': content = <LibraryDashboard setPage={handleSetPage} />; break;
  ...
  // --> NEW: ADDED library_dashboard TO FULL SCREEN PAGES
  const isFullScreenPage = ['owner', 'dashboard', 'booking-selection', 'library_dashboard'].includes(page.name);
